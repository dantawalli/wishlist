...
function uuid(){
    return "xxxxxxx-xxxx-4xxx-yxxx-xxxxxxxx".replace(/[xy]/g, function (param){
...
function renderTodoList(todoList){
    ...
    <div class="todo relative">
        ...
        <button class="absolute right-0 button cursor todo">
            <span data-todokey=${id} class= "material-icons-outlined">delete</span>
        </button>
    </div>`)
}
